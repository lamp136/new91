...
<div id="updateContact" class="modal hide fade in" style="display: none; ">
    <form action="<?php echo U('financing/saveChatImage');?>" method="post" class="form-horizontal" autocomplete="off" enctype="multipart/form-data" >
        ...
        <div class="modal-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="info[title]" class="input-xlarge"/>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div>
                        <a href='javascript:void(0)' onclick='addli(this)'>[+]</a><input type="file" class="default" name="url[]" >
                        </div>
                    </td>
                </tr>
                <input type="hidden" name="fid" value="<?php echo ($info['fid']); ?>">
                <input type="hidden" name="fname" value="<?php echo ($info['fname']); ?>">
                <input type="hidden" name="info[chat_id]" value="<?php echo ($info['chatId']); ?>">
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        <li>
                         ...
                         <li><a href="<?php echo U('Financing/listChatFina',array('fid'=>$info['fid'],'fname'=>$info['fname']));?>"><?php echo ($info['fname']); ?> 洽谈信息</a><span class="divider">&nbsp;</span></li>
                        <li><a href="javascript:viod(0);"><?php echo ($info['name']); ?>  相册列表</a><span class="divider-last">&nbsp;</span></li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>商家相册列表</h4>
                                    <span class="tools">
                                        <a href="#" class="icon-plus">添加资质图片</a>
                                    </span>
                            </div>
                            
                            <div class="widget-body">
                                <table class="table table-striped table-bordered" id="sample_1" style="width:800px">
                                    <thead>
                                    <tr>
                                        <th width="25%">
                                        ...
                                        <th class="hidden-phone" width="50%">图片标题</th>
                                        
                                        <th class="hidden-phone" width="20%">操作</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php if(is_array($chatImageList)): $i = 0; $__LIST__ = $chatImageList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td align="center">
                                            ...
                                            <td id="w">
                                                <button type="button" class="btn btn-danger btn-small del" delid="<?php echo ($vo["id"]); ?>" url="<?php echo ($vo["url"]); ?>">
...
<script>
    ...
    $("#batchDel").click(function(){
         if(!window.confirm('确定要删除？')){
            ...
            $.ajax({
                url : '/system.php/Financing/deleteChatImage',
                type : 'POST',
                data : {'id':str,'url':url},
                async:false,
                dataType:'json',
