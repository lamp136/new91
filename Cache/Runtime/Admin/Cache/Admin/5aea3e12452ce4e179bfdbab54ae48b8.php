            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="javascript:;">合同电子档案</a><span class="divider">&nbsp;</span>
                        </li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>添加电子合同图片</h4>
                            </div>
                            <div class="widget-body form">
                                <!-- BEGIN FORM-->
                                <form id="defaultForm" method="post"  autocomplete="off" action="<?php echo U('StoreProfiles/imageAdd');?>" enctype="multipart/form-data">
                                    <div class="">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="图片名称" class="input-xxlarge" name="info[image_name]">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <a href='javascript:void(0)' onclick='addli(this)'>[+]</a><input type="file" class="default" name="image[]" >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <label class="radio">图片类型:</label>
                                                </td>
                                                <td>
                                                    <?php if(is_array(C("PROFILES_IMAGE_TYPE"))): $i = 0; $__LIST__ = C("PROFILES_IMAGE_TYPE");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="radio" name="info[type]" value="<?php echo ($key); ?>" checked ><?php echo ($vo); endforeach; endif; else: echo "" ;endif; ?>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                    ...
                                    <div class="form-actions">
                                        <input type='hidden' name="info[profiles_detail_id]" value="<?php echo ($id); ?>">
