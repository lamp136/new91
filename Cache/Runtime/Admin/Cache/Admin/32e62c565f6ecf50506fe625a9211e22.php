            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('Financing/listChatFina',array('fid'=>$info['fid'],'fname'=>$info['fname']));?>"><?php echo ($info['fname']); ?>  洽谈列表</a><span class="divider">&nbsp;</span></li>
                        <li><a href="javascript:viod(0);">添加洽谈信息</a><span class="divider-last">&nbsp;</span></li>
                    </ul>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>添加洽谈信息</h4>
                            </div>
                            <div class="widget-body form">
                                <!-- BEGIN FORM-->
                                <form id="defaultForm" method="post"  autocomplete="off" action="<?php echo U('Financing/saveChatFina');?>" enctype="multipart/form-data">
                                    <div class="">
                                        <table class="table table-bordered table-hover">
                                            <tbody>
                                            <tr>
                                                <td>
                                                    <label class="control-label"><span style="color:red">*</span>公司名称/个人:</label>
                                                </td>
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="公司名称/个人" class="input-large" name="info[name]" data-rule='required' id='name'>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[status]" data-rule='required'>
                                                        ...
                                                        <?php if(is_array(C("CHAT_STATUS"))): $i = 0; $__LIST__ = C("CHAT_STATUS");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?> 
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="联系人" class="input-large" name="info[contracts]" data-rule='required' id='contract'>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="资质" class="input-large" name="info[qualification]">
                                                        </div>
                                                    </div>
                                                </td>  
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="联系人手机号" class="input-large" name="info[mobile]" id="mobiles">
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="固定电话" class="input-large" name="info[tel]" id='tel'>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input size="16" type="text" name="info[appointment]" value="<?php echo date('Y-m-d H:i:s');?>"  onClick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})" class="Wdate input-medium">
                                                    </div>
                                                </td>
                                                <td>
                                                    <label class="control-label">洽谈时间:</label>
                                                </td>
                                                <td>
                                                    <div class="controls">
                                                        <input size="16" type="text" name="info[chat_time]" value="<?php echo date('Y-m-d');?>"  onClick="WdatePicker({dateFmt: 'yyyy-MM-dd'})" class="Wdate input-medium">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td  colspan="3">
                                                    <div class="controls">
                                                        <textarea class="span6 " rows="3"  name="info[remark]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;"></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <div class="form-actions">
                                        <input type='hidden' name='fname' value="<?php echo ($info['fname']); ?>">
                                        <input type='hidden' name='info[finance_id]' value="<?php echo ($info['fid']); ?>">
