        ...
        <div class="modal-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="info[album_id]" value="<?php echo (C("STORE_IMG_GATEHOUSE")); ?>" checked>
                        门楼
                        <input type="radio" name="info[album_id]" value="<?php echo (C("STORE_IMG_SCENERY")); ?>">
                        景观
                        <input type="radio" name="info[album_id]" value="<?php echo (C("STORE_IMG_QUALIFICATION")); ?>">
                        资质
                    </td>
                </tr>
                <tr>
                ...
                <input type="hidden" name="info[store_id]" value="<?php echo ($storeId); ?>"/>
                <input type="hidden" name="np" value="<?php echo ($nowPage); ?>"/>
                ...
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        <li>
                         ...
                         <li><a href="<?php echo U('BaseStore/'.$listFunc,array('p'=>$nowPage,'sname'=>$sname,'sprovince'=>$sprovince));?>"><?php echo ($tips); ?>基础信息</a><span class="divider">&nbsp;</span></li>
                        <li><a href="javascript:viod(0);"><?php echo ($storename); ?>     相册列表</a><span class="divider-last">&nbsp;</span></li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i><?php echo ($tips); ?>相册列表</h4>
                                <span class="tools">
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td align="center">
                                                ...
                                                <?php else: ?>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;<?php endif; ?>
                                                <img src="<?php echo ($vo["thumb_image_url"]); ?>" style="width:50px;" />
                                                <img width="23px" title="放大" src="/Public/Admin/Img/zoomIn.png" class="zoomIn"   data-image="<?php echo ($vo["image_url"]); ?>">
                                            </td>
                                            <td><?php echo ($vo["title"]); ?></td>
                                            <td><?php if($vo["set_photo_album_status"] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
                                            <td>
                                                <?php if(C("STORE_IMG_GATEHOUSE")== $vo[album_id]): ?>门楼
                                                    <?php elseif(C("STORE_IMG_SCENERY")== $vo[album_id] ): ?>景观
                                                    <?php elseif(C("STORE_IMG_QUALIFICATION")== $vo[album_id]): ?>资质<?php endif; ?>
                                            </td>
                                            <td><?php echo ($vo["image_link"]); ?></td>
                                            <td><?php if($vo["state"] == 1): ?>是<?php else: ?><span style="color:red">已删除</span><?php endif; ?></td>
                                            <td><?php echo ($vo["sort"]); ?></td>
                                            <td id="w">
                                                <a href="javascript:;" data-id="<?php echo ($vo['id']); ?>" data-sid="<?php echo ($vo['store_id']); ?>" data-np="<?php echo ($p); ?>" data-sname="<?php echo ($sname); ?>" data-sprovince="<?php echo ($sprovince); ?>" class="btn btn-small btn-primary opCat data-pic">
                                                    <i class="icon-pencil icon-white"> </i> 编辑
                                                </a>
                                                <?php if($vo['state'] == 1): ?><button type="button" class="btn btn-danger btn-small del" onclick="deleteImage(<?php echo ($vo["id"]); ?>)">
                                                        <i class="icon-remove  icon-white"> </i>禁用
                                                    </button>
                                                <?php else: ?>
                                                    <a href="javascript:void(0)" class="btn btn-success btn-small enable" data-id="<?php echo ($vo["id"]); ?>">
