            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="javascript:void(0)">入库列表</a><span class="divider-last">&nbsp;</span>
                        </li>
                    </ul>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>入库列表</h4>
                            </div>
                            <div class="widget-body">
                                <form method="get" class="form-horizontal" autocomplete="off" action="<?php echo U('Storage/inputInventory');?>">
                                    搜索：
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    <thead>
                                    <tr>
                                        <th class="hidden-phone">申请单SN</th>
