                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <form id="quickForm" method="get" class="form-horizontal" autocomplete="off" action="/system.php/Financial/finishPayment.html">搜索：
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($finishPayList)): $i = 0; $__LIST__ = $finishPayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <td><?php echo (C("FINANCIAL_STATUS.$vo[status]")); ?></td>
                                            <td>
                                                <button  class="btn btn-small btn-primary opCat recording" data-id='<?php echo ($vo["id"]); ?>'>
                                                    <i class=""> </i>查看付款记录
                                                </button>
                                            </td>
