                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                ...
                                <?php if (showHandle('BaseStore/addCemetery')) { ?>
                                    <span class="tools">
                                        <a href="<?php echo U('BaseStore/addCemetery');?>" class="icon-plus">添加陵园</a>
                                    </span>
                                <?php } ?>
                            </div>
                            <div class="widget-body">
                                <div class="control-group">
                                    <div class="controls">
                                        <form action="/system.php/BaseStore/cemeteryList.html" method="get" class="form-horizontal">
                                            <span>搜索：</span>
                                            ...
                                            <select name="smemberStatus" class="input-medium">
                                                ...
                                                <option value="<?php echo (C("STOER_MERMBER_AD")); ?>" <?php if(($getInfo[smemberStatus]) == C("STOER_MERMBER_AD")): ?>selected='selected'<?php endif; ?> ><?php echo (C("STOER_MERMBER_AD_MSG")); ?></option>
                                                <option value="<?php echo (C("STOER_MERMBER_PERSON")); ?>" <?php if(($getInfo[smemberStatus]) == C("STOER_MERMBER_PERSON")): ?>selected='selected'<?php endif; ?> ><?php echo (C("STOER_MERMBER_PERSON_MSG")); ?></option>
                                                <option value="<?php echo (C("STOER_MERMBER")); ?>" <?php if(($getInfo[smemberStatus]) == C("STOER_MERMBER")): ?>selected='selected'<?php endif; ?> ><?php echo (C("STOER_MERMBER_MSG")); ?></option>
                                            </select>
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <!--<td><?php if($vo["member_status"] == 0): ?>否<?php else: ?>是<?php endif; ?></td>-->
                                            <td>
                                                <?php switch($vo["member_status"]): case "0": ?>否<?php break;?>
                                            ...
                                            <td>
                                                <?php if (showHandle('BaseStore/editCemetery')) { ?>
                                                <a href="<?php echo U('BaseStore/editCemetery',array('sid'=>$vo['store_id'],'np'=>$nowPage, 'sname'=>$sname, 'sprovince'=>$sprovince,'scity'=>$scity));?>" class="btn btn-small btn-primary opCat">
                                                ...
                                                <?php } if (showHandle('BaseStore/attributesCemetiry')) { ?>
                                                <a href="<?php echo U('BaseStore/attributesCemetiry', array('sid'=>$vo['store_id'],'np'=>$nowPage, 'sname'=>$sname, 'sprovince'=>$sprovince));?>" class="btn btn-small btn-info">
                                                    属性
                                                </a>
                                                 <?php } if (showHandle('BaseStore/albumCeletery')) { ?>
                                                <a href="<?php echo U('BaseStore/albumCeletery', array('sid'=>$vo['store_id'],'np'=>$nowPage, 'sname'=>$sname, 'sprovince'=>$sprovince));?>"  class="btn btn-small">
                                                ...
                                                <?php } if (showHandle('BaseStore/storeGoods')) { ?>
                                                <a href="<?php echo U('BaseStore/storeGoods',array('sid'=>$vo['store_id'],'np'=>$nowPage));?>" class="btn btn-small btn-warning">
                                                    <i class="icon-sitemap"> </i>商品
                                                </a>
                                                <?php } if (showHandle('BaseStore/celebrityList')) { ?>
                                                <a href="<?php echo U('BaseStore/celebrityList',array('sid'=>$vo['store_id'],'np'=>$nowPage, 'sname'=>$sname, 'sprovince'=>$sprovince));?>" class="btn btn-small">
                                                    名人
                                                </a>
                                                 <?php } ?>
                                            </td>
