                                    ...
                                    <table class="table table-striped table-bordered" id="sample_1">
                                        ...
                                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                ...
                                                <td class="hidden-phone" width="28%">
                                                    ...
                                                    <?php if($vo['status'] == C('SERVICE_ORDER_STATUS.ALLOW')): ?><a  class="btn btn-danger btn-small applybackorder" href="javascript:void(0)" data-orderId="<?php echo ($vo["order_son_sn"]); ?>"><i class="icon-remove icon-white"> </i>可以退单</a>
                                                  
                                                     <?php elseif($vo['status'] == C('SERVICE_ORDER_STATUS.BACK_SUCCESS')): ?><a  class=" btn btn-danger btn-small backorder" href="javascript:void(0)" data-orderId="<?php echo ($vo["order_son_sn"]); ?>"><i class="icon-success icon-white"> </i>退单完成
                                                    </a><?php endif; ?>
                                             </td>
