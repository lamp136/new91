            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('Financing/listImgFina',array('fid'=>$fid,'fname'=>$fname));?>"><?php echo ($fname); ?>     相册列表</a><span class="divider">&nbsp;</span></li>
                        <li><a href="javascript:viod(0);">添加图片</a><span class="divider-last">&nbsp;</span></li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>添加融资相册</h4>
                            </div>
                            <div class="widget-body form">
                                <!-- BEGIN FORM-->
                                <form id="defaultForm" method="post"  autocomplete="off" action="<?php echo U('Financing/insertImgFina');?>" enctype="multipart/form-data">
                                    <div class="">
                                        <table class="table table-bordered table-hover">
                                            <tbody>
                                            <tr>
                                                <td>
                                                    <label class="radio">相册类型:</label>
                                                </td>
                                                <td>
                                                    <div class="controls">
                                                        <input type="radio" name="info[type]" value="0" checked='true'>
                                                        合同
                                                        <input type="radio" name="info[type]" value="1">
                                                        景观 
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="标题" class="input-xxlarge" name="info[title]">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="radio" name="info[recommends]" value="0" checked>
                                                        不推荐 
                                                        <input type="radio" name="info[recommends]" value="1">
                                                        推荐
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="链接地址" class="input-xxlarge" name="info[pic_url]">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <div class="form-actions">
                                        <input type='hidden' name='info[finance_id]' value="<?php echo ($fid); ?>">
