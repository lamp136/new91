        ...
        <div class="modal-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="info[type]" value="<?php echo (C("GOODS_IMAGE_SMALL")); ?>"  checked>
                        轮播图
                        <input type="radio" name="info[type]" value="<?php echo (C("GOODS_IMAGE_DETAIL")); ?>">
                        详情图片
                    </td>
                </tr>
                <tr>
                ...
                <input type="hidden" name="info[service_goods_id]" value="<?php echo ($goodsId); ?>">
