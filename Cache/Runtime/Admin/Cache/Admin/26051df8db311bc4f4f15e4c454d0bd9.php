            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('ServiceGoods/index');?>">商品列表</a><span class="divider">&nbsp;</span></li>
                            ...
                            <div class="widget-body form">
                                ...
                                <form id="defaultForm" method="post"  autocomplete="off" action="<?php echo U('ServiceGoods/saveGoods');?>" enctype="multipart/form-data">
                                    <div class="">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[category_pid]" id="category_pid" data-rule='required'>
                                                        ...
                                                        <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i; if($list['category_pid'] == $cat['cid']): ?><option value="<?php echo ($cat["cid"]); ?>" selected="selected"><?php echo ($cat["name"]); ?></option>
                                                            <?php else: ?>
                                                    ...
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[category_id]" id="category_id" <?php if(empty($categoryList)): ?>style="display:none"<?php endif; ?>>
                                                        <?php if(is_array($categoryList)): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i; if($list['category_id'] == $res['cid']): ?><option value="<?php echo ($res["cid"]); ?>" selected="selected"><?php echo ($res["name"]); ?></option>
                                                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="商品名称" class="input-xxlarge" name="info[name]" value="<?php echo ($list["name"]); ?>" data-rule='required'>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr id='checkgoods' <?php if(empty($product)): ?>style="display:none"<?php endif; ?> >
                                                <td>
                                                    <label class="control-label">选择商品:</label>
                                                </td>
                                                <td id="package">
                                                    <?php if(is_array($allGoods)): $i = 0; $__LIST__ = $allGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><input type="checkbox" onclick='number(this)' name='skuid[]' value='<?php echo ($res["skuid"]); ?>' <?php if(in_array(($res["skuid"]), is_array($array['skuid'])?$array['skuid']:explode(',',$array['skuid']))): ?>checked<?php endif; ?> ><?php echo ($res["name"]); ?>
                                                        <span>
                                                            <?php if(in_array(($res["skuid"]), is_array($array['skuid'])?$array['skuid']:explode(',',$array['skuid']))): ?>&nbsp;&nbsp;数量:<input type='number' style='width:50px' name='number[]' value="<?php echo ($array['number']["$res[skuid]"]); ?>"><?php endif; ?>
                                                        </span>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="商品单位" class="input-xxlarge" name="info[unit]" value="<?php echo ($list["unit"]); ?>" >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[storage_id]">
                                                        ...
                                                        <?php if(is_array($storage)): $i = 0; $__LIST__ = $storage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sto): $mod = ($i % 2 );++$i; if($list['storage_id'] == $sto['id']): ?><option value="<?php echo ($sto["id"]); ?>" selected="selected"><?php echo ($sto["storage_name"]); ?></option>
                                                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <img src="<?php echo ($list["thumb_url"]); ?>" width="80px" height="80px">
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td  colspan="3">
                                                    <div class="controls">
                                                        <textarea class="span7 " rows="3"  name="info[summary]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;"><?php echo ($list["summary"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td  colspan="3">
                                                    <div class="controls">
                                                        <textarea class="span7 " rows="3"  name="info[moral]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;"><?php echo ($list["moral"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <textarea name="info[introduction]" class="input" id="content" style="width:750px;height: 400px;" data-rule='required'><?php echo ($list["introduction"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[status]" data-rule='required'>
                                                        ...
                                                        <?php if(is_array(C("SERVICEGOODS_STATUS"))): $i = 0; $__LIST__ = C("SERVICEGOODS_STATUS");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($list['status'] == $key): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?> 
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="警戒线" class="input-xxlarge" name="info[cordon]" value="<?php echo ($list["cordon"]); ?>">
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <div class="form-actions">
                                        <input type="hidden" name='goodsId' value='<?php echo ($list["id"]); ?>'>
                                        <input type="hidden" name='image_url' value='<?php echo ($list["image_url"]); ?>'>
                                        <input type="hidden" name='thumb_url' value='<?php echo ($list["thumb_url"]); ?>'>
