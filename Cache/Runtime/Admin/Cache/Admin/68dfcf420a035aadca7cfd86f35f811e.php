            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('Storage/index');?>">商家商品列表</a><span class="divider">&nbsp;</span></li>
                            ...
                            <div class="widget-body form">
                                ...
                                <form id="defaultForm" method="post"  autocomplete="off" action="<?php echo U('StoreGoods/saveStoreGoods');?>" enctype="multipart/form-data">
                                    <div class="">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-small m-wrap" tabindex="1" name="info[province_id]" id="province">
                                                        ...
                                                        <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pro): $mod = ($i % 2 );++$i; if($pro[region_id] == $store_province[province_id]): ?><option value="<?php echo ($pro["region_id"]); ?>" selected="selected"><?php echo ($pro["region_name"]); ?></option>
                                                            <?php else: ?>
                                                    ...
                                                    <select class="input-small m-wrap" tabindex="1" name="info[city_id]" id="city">
                                                        <option value="0">--请选择-- </option>
                                                        <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cit): $mod = ($i % 2 );++$i; if($cit['region_id'] == $store_province['city_id']): ?><option value="<?php echo ($cit["region_id"]); ?>" selected><?php echo ($cit["region_name"]); ?></option>
                                                            <?php else: ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class='chosen' name='info[store_id]' data-id="store_name" data-placeholder="选择商家" data-rule='required' >
                                                        ...
                                                        <?php if(is_array($storeList)): $i = 0; $__LIST__ = $storeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$st): $mod = ($i % 2 );++$i; if($st['store_id'] == $result['store_id']): ?><option value="<?php echo ($st["store_id"]); ?>" selected><?php echo ($st["store_name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($st["store_id"]); ?>"><?php echo ($st["store_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[category_pid]" id="category_pid" data-rule='required'>
                                                        ...
                                                        <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cat): $mod = ($i % 2 );++$i; if($result['category_pid'] == $cat['cid']): ?><option value="<?php echo ($cat["cid"]); ?>" selected="selected"><?php echo ($cat["name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($cat["cid"]); ?>"><?php echo ($cat["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[category_id]" id="category_id" <?php if(empty($categoryList)): ?>style="display:none"<?php endif; ?>>
                                                        <option value="">--请选择--</option>
                                                        <?php if(is_array($categoryList)): $i = 0; $__LIST__ = $categoryList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i; if($result['category_id'] == $res['cid']): ?><option value="<?php echo ($res["cid"]); ?>" selected="selected"><?php echo ($res["name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($res["cid"]); ?>"><?php echo ($res["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                     <select class="input-medium m-wrap" tabindex="1" name="goods_id" id="goods_id" data-rule='required' <?php if(empty($allGoods)): ?>style="display:none"<?php endif; ?>>
                                                        <option value="">--请选择--</option>
                                                        <?php if(is_array($allGoods)): $i = 0; $__LIST__ = $allGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$god): $mod = ($i % 2 );++$i; if($result['skuid'] == $god['skuid']): ?><option value="<?php echo ($god["id"]); ?>" selected="selected"><?php echo ($god["name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($god["id"]); ?>"><?php echo ($god["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="商品名称" value="<?php echo ($result['service_goods_name']); ?>" id='goodsName' class="input-xxlarge" name="info[service_goods_name]" data-rule='required'>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="市场价" class="input-xxlarge" value="<?php echo ($result['market_price']); ?>" name="info[market_price]" data-rule='required'>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="销售价" class="input-xxlarge" name="info[sales_price]" value="<?php echo ($result['sales_price']); ?>" data-rule='required' >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="数量" class="input-xxlarge" name="info[number]" value="<?php echo ($result['number']); ?>" >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" id='storage' name="info[storage_id]">
                                                        <option value="0">--请选择--</option>
                                                        <?php if(is_array($storage)): $i = 0; $__LIST__ = $storage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sto): $mod = ($i % 2 );++$i; if($sto[id] == $result[storage_id]): ?><option value="<?php echo ($sto["id"]); ?>" selected="selected"><?php echo ($sto["storage_name"]); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo ($sto["id"]); ?>" ><?php echo ($sto["storage_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <input type="text" placeholder="库存" class="input-xxlarge" name="info[inventory]" value="<?php echo ($result['inventory']); ?>" readonly="readonly" <?php if(empty($result['inventory'])): ?>style="border:1px solid red"<?php endif; ?> >
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <img src="<?php echo ($result["thumb_url"]); ?>" width="80px" height="80px" id='img'>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="用于SEO的title" class="input-xxlarge" name="info[seo_title]" value="<?php echo ($result["seo_title"]); ?>"> 
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="control-group">
                                                        <div class="controls">
                                                            <input type="text" placeholder="用于SEO的keywords" class="input-xxlarge" name="info[seo_keywords]" value="<?php echo ($result["seo_keywords"]); ?>" data-rule='required'> 
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="controls">
                                                        <textarea class="span6 " rows="3"  name="info[seo_description]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;" data-rule='required' placeholder="用于SEO的description"><?php echo ($result["seo_description"]); ?></textarea>
                                            ...
                                            <tr>
                                                ...
                                                <td  colspan="3">
                                                    <div class="controls">
                                                        <textarea class="span7 " rows="3"  name="info[summary]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;"><?php echo ($result["summary"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td  colspan="3">
                                                    <div class="controls">
                                                        <textarea class="span7 " rows="3"  name="info[moral]" style="margin-top: 0px; margin-bottom: 10px; height: 123px;"><?php echo ($result["moral"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <textarea name="info[introduction]" class="input" id="content" style="width:750px;height: 400px;" data-rule='required'><?php echo ($result["introduction"]); ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <input type="radio" name='info[coupon]' value='1' <?php if($result["coupon"] == 1): ?>checked='ture'<?php endif; ?> >能
                                                        <input type="radio" name='info[coupon]' value='2' <?php if($result["coupon"] == 2): ?>checked='ture'<?php endif; ?>>不能
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="input-medium m-wrap" tabindex="1" name="info[status]" data-rule='required'>
                                                        <option value="">---请选择---</option>
                                                        <?php if(is_array(C("SERVICEGOODS_STATUS"))): $i = 0; $__LIST__ = C("SERVICEGOODS_STATUS");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($result['status'] == $key): ?>selected<?php endif; ?> ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?> 
                                                    </select>
                                                </td>
                                            </tr>
                                            </tbody>
                                    ...
                                    <div class="form-actions">
                                        <input type="hidden" name='storeGoodsId' value="<?php echo ($result["id"]); ?>">
