                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                ...
                                <?php if (showHandle('ServiceGoods/addGoods')) { ?>
                                    <span class="tools">
                                        <a href="<?php echo U('ServiceGoods/addGoods');?>" class="icon-plus">
                                            添加商品
                                        </a>
                                    </span>
                                <?php } ?>
                            ...
                            <div class="widget-body">
                                <form id="quickForm" method="get" class="form-horizontal" autocomplete="off" action="<?php echo U('ServiceGoods/index');?>">
                                    搜索：
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <tbody>
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                                ...
                                                <td><?php echo ($vo["cordon"]); ?></td>
                                                <td><?php echo (C("SERVICEGOODS_STATUS.$vo[status]")); ?></td>
                                                <td><?php echo (date('Y-m-d',$vo["created_time"])); ?></td>
                                                <td>
                                                <?php if (showHandle('ServiceGoods/editGoods')) { ?>
                                                    <a href="<?php echo U('ServiceGoods/editGoods',array('id'=>$vo['id'],'p'=>$nowPage));?>" class="btn btn-small btn-primary opCat">
                                                        <i class="icon-pencil icon-white"> </i>编辑
                                                    </a>
                                                <?php } if (showHandle('ServiceGoods/goodsImage')) { ?>
                                                    <a href="<?php echo U('ServiceGoods/goodsImage', array('id'=>$vo['id'],'p'=>$nowPage, 'name'=>$vo['name']));?>"  class="btn btn-small">
                                                        <i class="icon-picture"> </i>相册
                                                    </a>
                                                <?php } if (showHandle('ServiceGoods/delGoods')){ ?> 
                                                    ...
                                                    <?php else: ?>
                                                        <button type="button" class="btn btn-danger btn-small del" data-id="<?php echo ($vo["id"]); ?>" data-status="<?php echo (C("DELETE_STATUS")); ?>"/>
                                                         <i class="icon-remove  icon-white"> </i>删除</button><?php endif; ?>
                                                <?php } if (showHandle('ServiceGoods/addApply')) { ?> 
                                                    <button type="button" class="btn btn-small btn-primary apply" data-id="<?php echo ($vo["id"]); ?>"/>
                                                    <i></i>申购
                                                 <?php } ?>
                                                </td> 
