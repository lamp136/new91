            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="javasript:void(0)">订单支付完成列表</a><span class="divider-last">&nbsp;</span>
                        </li>
                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>订单支付完成</h4>
                            </div>
                            <div class="widget-body">
                                <form id="quickForm" method="get" class="form-horizontal" autocomplete="off" action="/system.php/OrderService/finishPay.html">搜索：
                                    <input type="text" name="order_main_sn" class="input-large" placeholder="订单号" value="<?php echo ($_GET['order_main_sn']); ?>"/>
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <td><?php echo ($vo["member_contact"]); ?></td>
                                            <td><?php echo (date("Y-m-d",$vo["order_service_time"])); ?></td>
                                            <td>
                                                <a href="<?php echo U('orderDetails',array('id'=>$vo['id']));?>" target="_blank" class="btn btn-small btn-primary opCat" data-id='<?php echo ($vo["id"]); ?>'>
                                                    <i class=""> </i>查看详情
                                                </a>
                                            </td>
