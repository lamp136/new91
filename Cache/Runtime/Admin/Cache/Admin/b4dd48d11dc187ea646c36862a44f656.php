                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <form id="quickForm" method="get" class="form-horizontal" autocomplete="off" action="/system.php/Financial/littlePayment.html">搜索：
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($littlePayList)): $i = 0; $__LIST__ = $littlePayList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
