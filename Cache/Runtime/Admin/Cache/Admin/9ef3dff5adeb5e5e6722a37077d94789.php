            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="<?php echo U('storeNew',array('sid'=>$storeInfo['store_id'],'np'=>$np,'sname'=>$sname,'sprovince'=>$sprovince));?>"><?php echo ($storeInfo["store_name"]); ?>新闻列表</a><span class="divider">&nbsp;</span></li>
                        <li><a href="javascript:void(0)"><?php echo ($newsInfo["title"]); ?>新闻图片列表</a><span class="divider-last">&nbsp;</span></li>
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>商家新闻图片列表</h4>
                                    <?php if (showHandle('BaseStore/addNewImage')) { ?>
                                        <span class="tools">
                                            <a href="javascript:;"  class="icon-plus addNewImage" data-nid="<?php echo ($newsId); ?>">
                                                添加图片
                                            </a>
                                        </span>
                                    <?php } ?>
                            ...
                            <div class="widget-body">
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <td><img src="<?php echo ($vo["thumbnail"]); ?>" alt="" width="88px"/></td>
                                            <td><?php echo ($vo["sort"]); ?></td>
                                            <td>
                                                <?php if (showHandle('BaseStore/delNewImage')) { ?>
                                                    <a href="javascript:void(0)" class="btn btn-danger btn-small delNewImage" data-id="<?php echo ($vo["id"]); ?>">
...
<div id="addNewImage" class="modal hide fade in" style="display: none; ">
    <form id="addForm" method="post" class="form-horizontal" autocomplete="off"  enctype="multipart/form-data">
        ...
        <div class="modal-body">
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; endforeach; endif; else: echo "" ;endif; ?>
