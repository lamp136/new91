                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                ...
                                <div class="widget-body">
                                    <form id="quickForm" method="get" class="form-horizontal" autocomplete="off" action='<?php echo U("returnPesentList");?>'>
                                    <table>
                                        <tr>
                                            <td>搜索：</td>
                                            <td>
                                        ...
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            ...
                                            <td>
                                             ...
                                             <?php if (showHandle('OrderGrave/orderbillinfo')) { ?>
                                                ...
                                                <?php if (showHandle('Money/returnForSuccess')) { ?>
                                                 <a class="btn btn-success btn-small returnforsuccess" href="javascript:void(0)" data-returnMoney="<?php echo ($vo["return_money"]); ?>" data-buyer="<?php echo ($vo["buyer"]); ?>" data-memberId="<?php echo ($vo["member_id"]); ?>" data-orderId="<?php echo ($vo["id"]); ?>" data-mobile="<?php echo ($vo["mobile"]); ?>"><i class="icon-ok icon-white"> </i>返现完成</a><?php } ?>
                                            </td>
   ...
   function dataType(d){
       ...
       $('.'+d).css('display','');
        ...
        $('#returnforsuccessForm').bind('valid.form', function () {
            ...
            $.ajax({
                url:"<?php echo U('returnForSuccess');?>",
                type:'POST',
                data:backorderFrom,
                processData: false,
                contentType: false,
