                    ...
                    <div class="span12">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                ...
                                <?php if (showHandle('BaseStore/refreshScore')) { ?>
                                    <span class="tools">
                            ...
                            <div class="widget-body">
                                <div class="control-group">
                                    <div class="controls">
                                        <form action="/system.php/BaseStore/storeScore.html?sname=&amp;sprovince=0&amp;scity=0" method="get" class="form-horizontal">
                                            <span>搜索：</span>
                                            <input type="text" placeholder="商家名称" class="input-medium" name="sname"  value="<?php echo ($getVal['sname']); ?>">
                                            <select class="input-small m-wrap" tabindex="1" name="sprovince" id="province">
                                                <option value="0">选择省</option>
                                                <?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["region_id"]); ?>" <?php if(($getVal['sprovince']) == $vo['region_id']): ?>selected<?php endif; ?>>
                                                        <?php echo ($vo["region_name"]); ?>
                                                    </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                            <select class="input-small m-wrap" tabindex="1" name="scity" id="city">
                                                <option value="0">选择市</option>
                                                <?php if(is_array($city)): $i = 0; $__LIST__ = $city;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["region_id"]); ?>" <?php if(($getVal['scity']) == $vo['region_id']): ?>selected<?php endif; ?>>
                                                        <?php echo ($vo["region_name"]); ?>
                                                    </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>                                   
                                ...
                                <table class="table table-striped table-bordered" id="sample_1">
                                    ...
                                    <tbody>
                                    <?php if(is_array($storeList)): $i = 0; $__LIST__ = $storeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
                                            <td id="store_name"><?php echo ($vo["store_name"]); ?></td>
                                            <td><?php echo ($vo["score"]); ?></td>
                                            <td>
                                                <?php if(!empty($vo["score_remark"])): echo ($vo["score_remark"]); endif; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if (showHandle('BaseStore/scoreUpdate')) { ?>
                                                    <a href="javascript:void(0);" data-id="<?php echo ($vo["store_id"]); ?>" class="btn btn-small btn-primary scoreUpdate">
