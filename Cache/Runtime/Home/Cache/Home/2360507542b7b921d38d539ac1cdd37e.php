...
<head>
    ...
    <title>注册会员_<?php echo (C("SITE_NAME")); ?></title>
    <link href="<?php echo (CSS_URL); ?>screen.css" media="screen, projection" rel="stylesheet" type="text/css"/>
</head>
<body>
    
<!-- 弹出协议内容背景层 -->
<div class="igree_box_bg"></div>
<!-- 点击我已阅读了搜墓网的《用户协议》—— 弹出协议内容 -->
<div class="igree_box">
	<div class="igree_title">91搜墓网用户注册协议</div>
	<!-- 用户协议+同意并继续按钮 -->
	<div class="igree_main_box">
		<!-- 用户协议 -->
		<div class="igree_main">
			<!-- 用户协议内容 -->
			<div class="help_agreement">
				<p>一、到91搜墓网服务条款的确认和接纳</p>
				<p>到91搜墓网（以下简称本站）的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。用户必须完全同意所有服务条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在下订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。</p>
				<p>二、服务简介</p>
				<h2>本站运用自己的操作系统通过国际互联网络为用户提供网络服务。同时，用户必须：</h2>
				<p>1、自行配备上网的所需设备，包括个人电脑、调制解调器或其他必备上网装置。</p>
				<p>2、自行负担个人上网所支付的与此服务有关的电话费用、网络费用。</p>
				<h2>基于本站所提供的网络服务的重要性，用户应同意：</h2>
				<p>1、提供详尽、准确的个人资料。</p>
				<p>2、不断更新注册资料，符合及时、详尽、准确的要求。</p>
				<h2>本站对用户的电子邮件、手机号等隐私资料进行保护，承诺不会在未获得用户许可的情况下擅自将用户的个人资料信息出租或出售给任何第三方，但以下情况除外：</h2>
				<p>1、用户同意让第三方共享资料；</p>
				<p>2、用户同意公开其个人资料，享受为其提供的产品和服务；</p>
				<p>3、本站需要听从法庭传票、法律命令或遵循法律程序；</p>
				<p>4、本站发现用户违反了本站服务条款或本站其它使用规定。</p>
				<p>注：关于用户隐私的具体协议以本站的隐私声明为准。如果用户提供的资料包含有不正确的信息，本站保留结束用户使用网络服务资格的权利。</p>
				<p>三、价格和数量</p>
				...
				<p>五、用户的账户，密码和安全性</p>
				<p>用户一旦注册成功，成为本站的合法用户，将得到一个密码和用户名。您可随时根据指示改变您的密码。用户将对用户名和密码安全负全部责任。另外，每个用户都要对以其用户名进行的所有活动和事件负全责。用户若发现任何非法使用用户账户或存在安全漏洞的情况，请立即通告本站。</p>
				<p>六、拒绝提供担保</p>
				...
				<p>1、停止使用本站的网络服务。</p>
				<p>2、通告本站停止对该用户的服务。</p>
				<p>3、结束用户服务后，用户使用网络服务的权利马上中止。从那时起，用户有权利，本站也没有义务传送任何未处理的信息或未完成的服务给户或第三方。</p>
				<p>十一、通告</p>
			...
			</div><!-- help_agreement用户协议内容结束 -->
		</div><!-- igree_main用户协议结束 -->
		<!-- 同意并继续按钮 -->
		<div class="igree_btn">
			<input class="igree_btn_img" type="button" value="同意并继续"/>
		</div><!-- igree_btn -->
	</div><!-- igree_main_box用户协议+同意并继续按钮结束 -->
	<!-- 关闭按钮 -->
	<span class="tooltip_cloce"></span>
</div><!-- igree_box点击我已阅读了搜墓网的《用户协议》—— 弹出协议内容结束 -->
    
<!-- 头部header -->
<div class="header reg_height">
    <div class="contain">
        <!-- LOGO -->
        ...
        <div class="reg_right">
            <p>已有91搜墓网账号？<a class="reg_logbtn" href="<?php echo U('login');?>">登录</a></p>
        </div>
    </div><!-- contain -->
</div><!-- 头部header结束 -->
<!-- 中间内容部分 -->
<div class="register">
    <h1><span>会员注册</span></h1>
    <!-- 注册左侧 -->
    <div class="regist_left">
        <form action="" method="post" name="registerForm" id="registerForm">
            <ul>
                <!-- 姓名 -->
                <li>
                    <input class="reg_tex" type="text" placeholder="您的姓名" name="name" />
                    <span id="nameError" class="reg_validate" style="display: none"><i></i>请填写您的姓名</span>
                </li>
                <!-- 手机号 -->
                <li>
                    <input class="reg_tex" type="text" placeholder="请输入您的手机号" name="mobile" />
                    <span id="mobileError" class="reg_validate" style="display: none"><i></i>请填写手机号</span>
                </li>
                <!-- 发送验证码 -->
                <li>
                    <input class="reg_tex regget_tex" type="text" placeholder="请输入动态验证码" name="msgcode" />
                    <input  class="getcode_btn" type="button" id="getting" value="获取验证码">
                    <span id="msgcodeError" class="reg_validate" style="display: none"><i></i>动态验证码不能为空</span>
                </li>
                <!-- 输入密码 -->
                <li>
                    <input class="reg_tex" type="password" placeholder="请输入密码" name="password" />
                    <span id="passwordError" class="reg_validate" style="display: none"><i></i>请输入6-16位的密码，支持数字、大小写字母</span>
                </li>
                <!-- 确认密码 -->
                <li>
                    <input class="reg_tex" type="password" placeholder="确认密码" name="repassword" />
                    <span id="repasswordError" class="reg_validate" style="display: none"><i></i>请再次输入密码</span>
                </li>
                <!-- 同意政策 -->
                <li class="igree">
                    <input class="reg_check" type="checkbox" checked="checked" name="protocol" />我已阅读了搜墓网的<a class="igree_click" href="#">《用户协议》</a>
                    <span id="protocolError" class="reg_validate" style="display: none"><i></i>您还未接受91搜墓网用户协议</span>
                </li>
                <!-- 立即注册按钮 -->
                <li><a class="register_btn" href="javascript:void(0)">立即注册</a></li>
            </ul>
        </form>
    </div><!-- regist_left注册左侧结束 -->
</div><!-- contain -->
<!-- 提示框 -->
<div class="tooltip_box"></div>
<div class="tooltip_pers">
    <div class="clearfix">
        <img src="<?php echo (IMG_URL); ?>pers_save.png" />
        <p id="content"></p>
    </div>
...
<script type="text/javascript" src="<?php echo (JS_URL); ?>home/register.js"></script>
</body>
</html>