var img = {
	 ...
	 init:function(){
		...
		img.autoplay= setInterval(function(){img.play(img.num+1)},3500);
		
		img.imageShow.onmouseover = function(){clearInterval(img.autoplay);}
		img.imageShow.onmouseout = function(){img.autoplay= setInterval(function(){img.play(img.num+1)},3500); }
